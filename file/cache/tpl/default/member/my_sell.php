...
<tr>
<td class="tab" id="add"><a href="?mid=<?php echo $mid;?>&action=add&xx=2"><span>添加<?php echo $MOD['name'];?></span></a></td>
<?php if($_userid) { ?>
<td class="tab" id="s3"><a href="?mid=<?php echo $mid;?>&xx=2"><span>已发布<span class="px10">(<?php echo $nums['3'];?>)</span></span></a></td>
<td class="tab" id="s2"><a href="?mid=<?php echo $mid;?>&status=2&xx=2"><span>审核中<span class="px10">(<?php echo $nums['2'];?>)</span></span></a></td>
<td class="tab" id="s1"><a href="?mid=<?php echo $mid;?>&status=1&xx=2"><span>未通过<span class="px10">(<?php echo $nums['1'];?>)</span></span></a></td>
<td class="tab" id="s4"><a href="?mid=<?php echo $mid;?>&status=4&xx=2"><span>已过期<span class="px10">(<?php echo $nums['4'];?>)</span></span></a></td>
<td class="tab" id="type"><a href="javascript:Dwidget('type.php?item=product&xx=2', '[<?php echo $MODULE['5']['name'];?>分类]', 600, 300);"><span><?php echo $MODULE['5']['name'];?>分类<span class="px10">(<?php echo $nums['0'];?>)</span></span></a></td>
<?php } ?>
</tr>
</table>
</div>
